      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">CartShake.com</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order ID: #28153</h1>
            ...
            <div className="flex border-t border-gray-200 py-2">
              <span className="text-gray-500">CartShake - (XL/Blue)</span>
              <span className="ml-auto text-gray-900">1</span>
              <span className="ml-auto text-gray-900">$19</span>
            </div>
            <div className="flex border-t border-gray-200 py-2">
              <span className="text-gray-500">CartShake - (XL/Blue)</span>
              <span className="ml-auto text-gray-900">1</span>
