...
export default function Home() {
  return (
    <div>
      ...
      <div>
        <img src="/banner3.jpg" alt="" width={1349} height={423}/>
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Welcome on CartShake</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Buy whatever you want | Wear wahtever you want !</p>
          </div>
